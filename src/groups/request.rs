...
impl GroupsIdApiClient {
    api_client_link!(owners, GroupsOwnersApiClient);
    api_client_link_id!(
    ...
    api_client_link_id!(permission_grant, PermissionGrantsIdApiClient);
    ...
    api_client_link_id!(transitive_member, TransitiveMembersIdApiClient);
